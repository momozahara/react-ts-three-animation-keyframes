...
function App() {
  ...
  return (
    <main>
      ...
      <div className="fixed bottom-2 left-0 min-w-full">
        <div className="flex justify-center items-center">
          <div className="p-4 w-full sm:w-3/4 bg-white rounded-md">
            <div className="space-y-2">
              ...
              <section>
                <p>
                  I am surprised that someone actually found this site via
                  search engine, so I decided to add this paragraph. You can
                  access the source by going to the root domain of this site,
                  but I will add a link to github repository to cut corner
                </p>
              </section>
